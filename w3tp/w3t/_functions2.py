...
def group_motions(experiments):
    ...
    upper_triangular_match_making_matrix[upper_triangular_match_making_matrix<0.90] = 0
    upper_triangular_match_making_matrix[upper_triangular_match_making_matrix>=0.90] = 1
