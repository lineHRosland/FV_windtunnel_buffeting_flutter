...
def tdms2h5_4loadcells(h5file,tdmsfile,ex1,ex2,wrong_side = False,load_cell_3_and_4_fixed=False):
    ...
    for k  in range(forces_volt.shape[0]):
        ...
        if load_cell_3_and_4_fixed == False:
        ...
        elif load_cell_3_and_4_fixed == True:
            transfrom_corotated2fixed = spla.block_diag(transfrom_corotated2fixed_n,transfrom_corotated2fixed_n,transfrom_corotated2fixed_n,transfrom_corotated2fixed_n,np.eye(3),np.eye(3),np.eye(3),np.eye(3))
