...
static_coeff_single_6_filtered, static_coeff_single_9_filtered = w3t._scoff.filter_by_reference(static_coeff_1=static_coeff_single_6,static_coeff_2=static_coeff_single_9,threshold=0.05,  threshold_low=[0.07, 0.05,0.05], threshold_high=[0.05,0.05,0.05],single=True)
...
static_coeff_MDS_1D_6_filtered, static_coeff_MDS_1D_8_filtered, static_coeff_MDS_1D_10_filtered = w3t._scoff.filter_by_reference(static_coeff_1=static_coeff_MDS_1D_6, static_coeff_2=static_coeff_MDS_1D_8, static_coeff_3=static_coeff_MDS_1D_10, threshold=0.015, threshold_low=[0.08,0.05,0.01],threshold_med = [0.005,0.03,0.05],threshold_high=[0.05,0.01,0.05],single=False)
