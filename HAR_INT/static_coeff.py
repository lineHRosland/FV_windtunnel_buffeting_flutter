...
#drag
alpha_drag_low, coeff_filtered_drag_low, alpha_drag_high, coeff_filtered_drag_high = w3t._scoff.filter_by_reference(static_coeff_single_low, static_coeff_single_high, threshold=0.05, scoff="drag", threshold_single_low=0.07, threshold_single_high=0.03)
...
#lift
alpha_lift_low, coeff_filtered_lift_low, alpha_lift_high, coeff_filtered_lift_high = w3t._scoff.filter_by_reference(static_coeff_single_low, static_coeff_single_high, threshold=0.05, scoff="lift", threshold_single_low=0.05, threshold_single_high=0.05)
...
#pitch
alpha_pitch_low, coeff_filtered_pitch_low, alpha_pitch_high, coeff_filtered_pitch_high = w3t._scoff.filter_by_reference(static_coeff_single_low, static_coeff_single_high, threshold=0.05, scoff="pitch", threshold_single_low=0.005, threshold_single_high=0.02)
...
#%%  Filter and plot ALT 2
#drag
alpha_drag_low, coeff_filtered_drag_up_low, coeff_filtered_drag_down_low, alpha_drag_med, coeff_filtered_drag_up_med, coeff_filtered_drag_down_med, alpha_drag_high, coeff_filtered_drag_up_high, coeff_filtered_drag_down_high = w3t._scoff.filter_by_reference(static_coeff_down_low, static_coeff_down_med, static_coeff_down_high, threshold=0.1, scoff="drag")
...
#pitch
alpha_pitch_low, coeff_filtered_pitch_up_low, coeff_filtered_pitch_down_low, alpha_pitch_med, coeff_filtered_pitch_up_med, coeff_filtered_pitch_down_med, alpha_pitch_high, coeff_filtered_pitch_up_high, coeff_filtered_pitch_down_high = w3t._scoff.filter_by_reference(static_coeff_down_low, static_coeff_down_med, static_coeff_down_high, threshold=0.1, scoff="pitch")
...
#%%  Filter and plot ALT 2
#drag
alpha_drag_low, coeff_filtered_drag_up_low, coeff_filtered_drag_down_low, alpha_drag_med, coeff_filtered_drag_up_med, coeff_filtered_drag_down_med, alpha_drag_high, coeff_filtered_drag_up_high, coeff_filtered_drag_down_high = w3t._scoff.filter_by_reference(static_coeff_up_low, static_coeff_up_med, static_coeff_up_high, threshold=0.1, scoff="drag")
...
#lift
alpha_lift_low, coeff_filtered_lift_up_low, coeff_filtered_lift_down_low, alpha_lift_med, coeff_filtered_lift_up_med, coeff_filtered_lift_down_med, alpha_lift_high, coeff_filtered_lift_up_high, coeff_filtered_lift_down_high = w3t._scoff.filter_by_reference(static_coeff_up_low, static_coeff_up_med, static_coeff_up_high, threshold=0.1, scoff="lift")
...
#pitch
alpha_pitch_low, coeff_filtered_pitch_up_low, coeff_filtered_pitch_down_low, alpha_pitch_med, coeff_filtered_pitch_up_med, coeff_filtered_pitch_down_med, alpha_pitch_high, coeff_filtered_pitch_up_high, coeff_filtered_pitch_down_high = w3t._scoff.filter_by_reference(static_coeff_up_low, static_coeff_up_med, static_coeff_up_high, threshold=0.1, scoff="pitch")
