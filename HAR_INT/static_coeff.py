...
file_names_6 = ["HAR_INT_SINGLE_02_00_003","HAR_INT_SINGLE_02_00_005"] # 6 ms
file_names_9 = ["HAR_INT_SINGLE_02_00_003","HAR_INT_SINGLE_02_00_004"] # 9 ms, Vibrations
...
exp0_single.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} 0 m/s – Before filtering", fontsize=16, y=1.02)
exp1_single_6.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} 6 m/s – Before filtering", fontsize=16, y=1.02)
exp1_single_9.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} 9 m/s – Before filtering", fontsize=16, y=1.02)
...
plt.gcf().suptitle(f"{section_name} 0 m/s – After filtering", fontsize=16, y=1.02)
...
#pitch
alpha_single, coeff_single_plot=w3t._scoff.filter(static_coeff_single_6, threshold=0.005, scoff="pitch", single = True)
...
plt.suptitle(f"{section_name}, 6 m/s", fontsize=16, y=1.05)
alpha_single, coeff_single_plot=w3t._scoff.filter(static_coeff_single_9, threshold=0.01, scoff="pitch", single = True)
...
file_names_MDS_1D_6 = ["HAR_INT_MUS_GAP_213D_02_02_000","HAR_INT_MUS_GAP_213D_02_02_001"] #6 ms, vibrations (Ser OK ut)
file_names_MDS_1D_8 = ["HAR_INT_MUS_GAP_213D_02_02_000","HAR_INT_MUS_GAP_213D_02_02_002"] # 8 ms, vibrations
file_names_MDS_1D_10 = ["HAR_INT_MUS_GAP_213D_02_02_000","HAR_INT_MUS_GAP_213D_02_02_003"] # 10 ms
...
exp0_MDS_1D.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 0 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MDS_1D_6.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 6 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MDS_1D_8.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 8 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MDS_1D_10.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 10 m/s – Before filtering", fontsize=16, y=1.02)
...
exp0_MDS_1D.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 0 m/s – After filtering", fontsize=16, y=1.02)
exp1_MDS_1D_6.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 6 m/s – After filtering", fontsize=16, y=1.02)
exp1_MDS_1D_8.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 8 m/s – After filtering", fontsize=16, y=1.02)
exp1_MDS_1D_10.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 10 m/s – After filtering", fontsize=16, y=1.02)
plt.show()
...
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MDS_1D_8, threshold=0.03, scoff="drag", single = False)
...
plt.suptitle(f"MDS_1D_Static, 6 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MDS_1D_8, threshold=0.03, scoff="lift", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=False, threshold=0.03, scoff="lift")
plt.suptitle(f"MDS_1D_Static, 8 m/s", fontsize=16, y=1.08)
...
plt.suptitle(f"MDS_1D_Static, 6 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MDS_1D_8, threshold=0.01, scoff="pitch", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=False, threshold=0.01, scoff="pitch")
plt.suptitle(f"MDS_1D_Static, 8 m/s", fontsize=16, y=1.08)
...
file_names_MUS_1D_5 = ["HAR_INT_MDS_GAP_213D_02_01_000","HAR_INT_MDS_GAP_213D_02_01_001"] # 5 ms
file_names_MUS_1D_8 = ["HAR_INT_MDS_GAP_213D_02_01_000","HAR_INT_MDS_GAP_213D_02_01_002"] # 8 ms, vibrations
file_names_MUS_1D_10 = ["HAR_INT_MDS_GAP_213D_02_01_000","HAR_INT_MDS_GAP_213D_02_01_003"] # 10 ms, vibrations
...
exp0_MUS_1D.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 0 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MUS_1D_5.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 5 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MUS_1D_8.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 8 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MUS_1D_10.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 10 m/s – Before filtering", fontsize=16, y=1.02)
...
exp0_MUS_1D.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 0 m/s – After filtering", fontsize=16, y=1.02)
exp1_MUS_1D_5.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 5 m/s – After filtering", fontsize=16, y=1.02)
exp1_MUS_1D_8.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 8 m/s – After filtering", fontsize=16, y=1.02)
exp1_MUS_1D_10.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 10 m/s – After filtering", fontsize=16, y=1.02)
plt.show()
...
#drag
alpha_low, coeff_plot_up_low, coeff_plot_down_low=w3t._scoff.filter(static_coeff_MUS_1D_5, threshold=0.06, scoff="drag", single = False)
...
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MUS_1D_8, threshold=0.04, scoff="drag", single = False)
...
alpha_high, coeff_plot_up_high, coeff_plot_down_high=w3t._scoff.filter(static_coeff_MUS_1D_10, threshold=0.02, scoff="drag", single = False)
...
#lift
alpha_low, coeff_plot_up_low, coeff_plot_down_low=w3t._scoff.filter(static_coeff_MUS_1D_5, threshold=0.04, scoff="lift", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=True, threshold=0.04, scoff="lift")
plt.suptitle(f"MUS_1D_Static, 5 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MUS_1D_8, threshold=0.04, scoff="lift", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med,upwind_in_rig=True, threshold=0.04, scoff="lift")
plt.suptitle(f"MUS_1D_Static, 8 m/s", fontsize=16, y=1.08)
alpha_high, coeff_plot_up_high, coeff_plot_down_high=w3t._scoff.filter(static_coeff_MUS_1D_10, threshold=0.04, scoff="lift", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_high,coeff_plot_up_high,coeff_plot_down_high, upwind_in_rig=True, threshold=0.04, scoff="lift")
plt.suptitle(f"MUS_1D_Static, 10 m/s", fontsize=16, y=1.08)

#pitch
alpha_low, coeff_plot_up_low, coeff_plot_down_low=w3t._scoff.filter(static_coeff_MUS_1D_5, threshold=0.01, scoff="pitch", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=True, threshold=0.01, scoff="pitch")
plt.suptitle(f"MUS_1D_Static, 5 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MUS_1D_8, threshold=0.01, scoff="pitch", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=True, threshold=0.01, scoff="pitch")
plt.suptitle(f"MUS_1D_Static, 8 m/s", fontsize=16, y=1.08)
alpha_high, coeff_plot_up_high, coeff_plot_down_high=w3t._scoff.filter(static_coeff_MUS_1D_10, threshold=0.01, scoff="pitch", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_high,coeff_plot_up_high,coeff_plot_down_high, upwind_in_rig=True, threshold=0.01, scoff="pitch")
plt.suptitle(f"MUS_1D_Static, 10 m/s", fontsize=16, y=1.08)
...
# Low wind speed
static_coeff_MDS_1D_6.to_excel(section_name, sheet_name="MDS - 6 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_1D_5.to_excel(section_name, sheet_name='MUS - 5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_6.to_excel(section_name, sheet_name='Single - 6 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# Medium wind speed
static_coeff_MDS_1D_8.to_excel(section_name, sheet_name="MDS - 8 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_1D_8.to_excel(section_name, sheet_name='MUS - 8 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9.to_excel(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# High wind speed
static_coeff_MDS_1D_10.to_excel(section_name, sheet_name="MDS - 10 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_1D_10.to_excel(section_name, sheet_name='MUS - 10 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9.to_excel(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

section_name = "1D_mean"

# Low wind speed
static_coeff_MDS_1D_6.to_excel_mean(section_name, sheet_name="MDS - 6 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_1D_5.to_excel_mean(section_name, sheet_name='MUS - 5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_6.to_excel_mean(section_name, sheet_name='Single - 6 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# Medium wind speed
static_coeff_MDS_1D_8.to_excel_mean(section_name, sheet_name="MDS - 8 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_1D_8.to_excel_mean(section_name, sheet_name='MUS - 8 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9.to_excel_mean(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# High wind speed
static_coeff_MDS_1D_10.to_excel_mean(section_name, sheet_name="MDS - 10 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_1D_10.to_excel_mean(section_name, sheet_name='MUS - 10 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9.to_excel_mean(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
...
# Low wind speed
static_coeff_MDS_1D_6_filtered.to_excel(section_name, sheet_name="MDS - 6 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_1D_5_filtered.to_excel(section_name, sheet_name='MUS - 5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_6_filtered.to_excel(section_name, sheet_name='Single - 6 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# Medium wind speed
static_coeff_MDS_1D_8_filtered.to_excel(section_name, sheet_name="MDS - 8 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_1D_8_filtered.to_excel(section_name, sheet_name='MUS - 8 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9_filtered.to_excel(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# High wind speed
static_coeff_MDS_1D_10_filtered.to_excel(section_name, sheet_name="MDS - 10 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_1D_10_filtered.to_excel(section_name, sheet_name='MUS - 10 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9_filtered.to_excel(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

section_name = "1D_mean_filtered"

# Low wind speed
static_coeff_MDS_1D_6_filtered.to_excel_mean(section_name, sheet_name="MDS - 6 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_1D_5_filtered.to_excel_mean(section_name, sheet_name='MUS - 5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_6_filtered.to_excel_mean(section_name, sheet_name='Single - 6 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# Medium wind speed
static_coeff_MDS_1D_8_filtered.to_excel_mean(section_name, sheet_name="MDS - 8 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_1D_8_filtered.to_excel_mean(section_name, sheet_name='MUS - 8 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9_filtered.to_excel_mean(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# High wind speed
static_coeff_MDS_1D_10_filtered.to_excel_mean(section_name, sheet_name="MDS - 10 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_1D_10_filtered.to_excel_mean(section_name, sheet_name='MUS - 10 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9_filtered.to_excel_mean(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
...
w3t._scoff.plot_compare_wind_speeds(static_coeff_single_6, static_coeff_single_9,
                             ...
                             scoff = "drag")                        
plt.gcf().suptitle(f"1D: MUS ", fontsize=16, y=1.02)
...
w3t._scoff.plot_compare_wind_speeds(static_coeff_single_6, static_coeff_single_9,
                               ...
                               static_coeff_MDS_1D_8, static_coeff_MDS_1D_10,
                                scoff = "drag")                        
plt.gcf().suptitle(f"1D: MDS ", fontsize=16, y=1.02)
...
file_names_MDS_2D_6 = ["HAR_INT_MUS_GAP_213D_02_00_001","HAR_INT_MUS_GAP_213D_02_00_002"] #6 ms
file_names_MDS_2D_8 = ["HAR_INT_MUS_GAP_213D_02_00_001","HAR_INT_MUS_GAP_213D_02_00_003"] # 8 ms, vibrations
file_names_MDS_2D_10 = ["HAR_INT_MUS_GAP_213D_02_00_001","HAR_INT_MUS_GAP_213D_02_00_004"] # 10 ms
...
exp0_MDS_2D.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 0 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MDS_2D_6.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 6 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MDS_2D_8.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 8 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MDS_2D_10.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 10 m/s – Before filtering", fontsize=16, y=1.02)
...
exp0_MDS_2D.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 0 m/s – After filtering", fontsize=16, y=1.02)
exp1_MDS_2D_6.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 6 m/s – After filtering", fontsize=16, y=1.02)
exp1_MDS_2D_8.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 8 m/s – After filtering", fontsize=16, y=1.02)
exp1_MDS_2D_10.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 10 m/s – After filtering", fontsize=16, y=1.02)
plt.show()
...
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=False, threshold=0.05, scoff="drag")
plt.suptitle(f"MDS_2D_Static, 6 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MDS_2D_8, threshold=0.0199, scoff="drag", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=False, threshold=0.0199, scoff="drag")
plt.suptitle(f"MDS_2D_Static, 8 m/s", fontsize=16, y=1.08)
...
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_high,coeff_plot_up_high,coeff_plot_down_high, upwind_in_rig=False, threshold=0.05, scoff="drag")
plt.suptitle(f"MDS_2D_Static, 10 m/s", fontsize=16, y=1.08)
...
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=False, threshold=0.05, scoff="lift")
plt.suptitle(f"MDS_2D_Static, 6 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MDS_2D_8, threshold=0.02, scoff="lift", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=False, threshold=0.02, scoff="lift")
plt.suptitle(f"MDS_2D_Static, 8 m/s", fontsize=16, y=1.08)
...
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=False, threshold=0.05, scoff="pitch")
plt.suptitle(f"MDS_2D_Static, 6 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MDS_2D_8, threshold=0.01, scoff="pitch", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=False, threshold=0.01, scoff="pitch")
plt.suptitle(f"MDS_2D_Static, 8 m/s", fontsize=16, y=1.08)
...
#%%  Filter and plot ALT 2
static_coeff_MDS_2D_6_filtered,static_coeff_MDS_2D_8_filtered,static_coeff_MDS_2D_10_filtered  = w3t._scoff.filter_by_reference(static_coeff_1=static_coeff_down_low, static_coeff_2=static_coeff_down_med, static_coeff_3=static_coeff_down_high, threshold=0.05, threshold_low=[0.05,0.05,0.05],threshold_med = [0.0199,0.02,0.01],threshold_high=[0.05,0.01,0.05],single=False)
...
file_names_MUS_2D_5 = ["HAR_INT_MDS_GAP_213D_02_00_000","HAR_INT_MDS_GAP_213D_02_00_001"] # 5 ms, vibrations
file_names_MUS_2D_8 = ["HAR_INT_MDS_GAP_213D_02_00_000","HAR_INT_MDS_GAP_213D_02_00_002"] # 8 ms, vibrations
file_names_MUS_2D_10 = ["HAR_INT_MDS_GAP_213D_02_00_000","HAR_INT_MDS_GAP_213D_02_00_003"] # 10 ms, vibrations
...
exp0_MUS_2D.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 0 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MUS_2D_5.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 5 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MUS_2D_8.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 8 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MUS_2D_10.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 10 m/s – Before filtering", fontsize=16, y=1.02)
...
exp0_MUS_2D.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 0 m/s – After filtering", fontsize=16, y=1.02)
exp1_MUS_2D_5.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 5 m/s – After filtering", fontsize=16, y=1.02)
exp1_MUS_2D_8.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 8 m/s – After filtering", fontsize=16, y=1.02)
exp1_MUS_2D_10.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 10 m/s – After filtering", fontsize=16, y=1.02)
plt.show()
...
plt.suptitle(f"MUS_2D_Static, 5 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MUS_2D_8, threshold=0.04, scoff="drag", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=True, threshold=0.04, scoff="drag")
plt.suptitle(f"MUS_2D_Static, 8 m/s", fontsize=16, y=1.08)
alpha_high, coeff_plot_up_high, coeff_plot_down_high=w3t._scoff.filter(static_coeff_MUS_2D_10, threshold=0.02, scoff="drag", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_high,coeff_plot_up_high,coeff_plot_down_high, upwind_in_rig=True, threshold=0.02, scoff="drag")
plt.suptitle(f"MUS_2D_Static, 10 m/s", fontsize=16, y=1.08)

#lift
alpha_low, coeff_plot_up_low, coeff_plot_down_low=w3t._scoff.filter(static_coeff_MUS_2D_5, threshold=0.025, scoff="lift", single = False)
...
plt.suptitle(f"MUS_2D_Static, 5 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MUS_2D_8, threshold=0.03, scoff="lift", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med,upwind_in_rig=True, threshold=0.03, scoff="lift")
plt.suptitle(f"MUS_2D_Static, 8 m/s", fontsize=16, y=1.08)
alpha_high, coeff_plot_up_high, coeff_plot_down_high=w3t._scoff.filter(static_coeff_MUS_2D_10, threshold=0.04, scoff="lift", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_high,coeff_plot_up_high,coeff_plot_down_high, upwind_in_rig=True, threshold=0.04, scoff="lift")
plt.suptitle(f"MUS_2D_Static, 10 m/s", fontsize=16, y=1.08)

#pitch
alpha_low, coeff_plot_up_low, coeff_plot_down_low=w3t._scoff.filter(static_coeff_MUS_2D_5, threshold=0.005, scoff="pitch", single = False)
...
plt.suptitle(f"MUS_2D_Static, 5 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MUS_2D_8, threshold=0.02, scoff="pitch", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=True, threshold=0.02, scoff="pitch")
plt.suptitle(f"MUS_2D_Static, 8 m/s", fontsize=16, y=1.08)
alpha_high, coeff_plot_up_high, coeff_plot_down_high=w3t._scoff.filter(static_coeff_MUS_2D_10, threshold=0.01, scoff="pitch", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_high,coeff_plot_up_high,coeff_plot_down_high, upwind_in_rig=True, threshold=0.01, scoff="pitch")
plt.suptitle(f"MUS_2D_Static, 10 m/s", fontsize=16, y=1.08)
...
# Low wind speed
static_coeff_MDS_2D_6.to_excel(section_name, sheet_name="MDS - 6 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_2D_5.to_excel(section_name, sheet_name='MUS - 5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_6.to_excel(section_name, sheet_name='Single - 6 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# Medium wind speed
static_coeff_MDS_2D_8.to_excel(section_name, sheet_name="MDS - 8 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_2D_8.to_excel(section_name, sheet_name='MUS - 8 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9.to_excel(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# High wind speed
static_coeff_MDS_2D_10.to_excel(section_name, sheet_name="MDS - 10 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_2D_10.to_excel(section_name, sheet_name='MUS - 10 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9.to_excel(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

section_name = "2D_mean"

# Low wind speed
static_coeff_MDS_2D_6.to_excel_mean(section_name, sheet_name="MDS - 6 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_2D_5.to_excel_mean(section_name, sheet_name='MUS - 5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_6.to_excel_mean(section_name, sheet_name='Single - 6 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# Medium wind speed
static_coeff_MDS_2D_8.to_excel_mean(section_name, sheet_name="MDS - 8 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_2D_8.to_excel_mean(section_name, sheet_name='MUS - 8 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9.to_excel_mean(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# High wind speed
static_coeff_MDS_2D_10.to_excel_mean(section_name, sheet_name="MDS - 10 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_2D_10.to_excel_mean(section_name, sheet_name='MUS - 10 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9.to_excel_mean(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
...
# Low wind speed
static_coeff_MDS_2D_6_filtered.to_excel(section_name, sheet_name="MDS - 6 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_2D_5_filtered.to_excel(section_name, sheet_name='MUS - 5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_6_filtered.to_excel(section_name, sheet_name='Single - 6 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# Medium wind speed
static_coeff_MDS_2D_8_filtered.to_excel(section_name, sheet_name="MDS - 8 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_2D_8_filtered.to_excel(section_name, sheet_name='MUS - 8 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9_filtered.to_excel(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# High wind speed
static_coeff_MDS_2D_10_filtered.to_excel(section_name, sheet_name="MDS - 10 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_2D_10_filtered.to_excel(section_name, sheet_name='MUS - 10 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9_filtered.to_excel(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

section_name = "2D_mean_filtered"

# Low wind speed
static_coeff_MDS_2D_6_filtered.to_excel_mean(section_name, sheet_name="MDS - 6 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_2D_5_filtered.to_excel_mean(section_name, sheet_name='MUS - 5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_6_filtered.to_excel_mean(section_name, sheet_name='Single - 6 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# Medium wind speed
static_coeff_MDS_2D_8_filtered.to_excel_mean(section_name, sheet_name="MDS - 8 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_2D_8_filtered.to_excel_mean(section_name, sheet_name='MUS - 8 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9_filtered.to_excel_mean(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# High wind speed
static_coeff_MDS_2D_10_filtered.to_excel_mean(section_name, sheet_name="MDS - 10 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_2D_10_filtered.to_excel_mean(section_name, sheet_name='MUS - 10 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9_filtered.to_excel_mean(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
...
w3t._scoff.plot_compare_wind_speeds(static_coeff_single_6, static_coeff_single_9,
                             ...
                             scoff = "drag")                        
plt.gcf().suptitle(f"2D: MUS ", fontsize=16, y=1.02)
...
w3t._scoff.plot_compare_wind_speeds(static_coeff_single_6, static_coeff_single_9,
                               ...
                               static_coeff_MDS_2D_8, static_coeff_MDS_2D_10,
                                scoff = "drag")                        
plt.gcf().suptitle(f"2D: MDS ", fontsize=16, y=1.02)
...
file_names_MDS_3D_6 = ["HAR_INT_MUS_GAP_213D_02_01_000","HAR_INT_MUS_GAP_213D_02_01_001"] #6 ms
file_names_MDS_3D_8 = ["HAR_INT_MUS_GAP_213D_02_01_000","HAR_INT_MUS_GAP_213D_02_01_002"] # 8 ms, vibrations
file_names_MDS_3D_10 = ["HAR_INT_MUS_GAP_213D_02_01_000","HAR_INT_MUS_GAP_213D_02_01_003"] # 10 ms
...
exp0_MDS_3D.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 0 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MDS_3D_6.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 6 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MDS_3D_8.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 8 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MDS_3D_10.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 10 m/s – Before filtering", fontsize=16, y=1.02)
...
exp0_MDS_3D.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 0 m/s – After filtering", fontsize=16, y=1.02)
exp1_MDS_3D_6.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 6 m/s – After filtering", fontsize=16, y=1.02)
exp1_MDS_3D_8.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 8 m/s – After filtering", fontsize=16, y=1.02)
exp1_MDS_3D_10.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 10 m/s – After filtering", fontsize=16, y=1.02)
plt.show()
...
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=False, threshold=0.05, scoff="drag")
plt.suptitle(f"MDS_3D_Static, 6 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MDS_3D_8, threshold=0.03, scoff="drag", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=False, threshold=0.03, scoff="drag")
plt.suptitle(f"MDS_3D_Static, 8 m/s", fontsize=16, y=1.08)
...
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_high,coeff_plot_up_high,coeff_plot_down_high, upwind_in_rig=False, threshold=0.05, scoff="drag")
plt.suptitle(f"MDS_3D_Static, 10 m/s", fontsize=16, y=1.08)
...
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=False, threshold=0.05, scoff="lift")
plt.suptitle(f"MDS_3D_Static, 6 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MDS_3D_8, threshold=0.03, scoff="lift", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=False, threshold=0.03, scoff="lift")
plt.suptitle(f"MDS_3D_Static, 8 m/s", fontsize=16, y=1.08)
...
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=False, threshold=0.05, scoff="pitch")
plt.suptitle(f"MDS_3D_Static, 6 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MDS_3D_8, threshold=0.01, scoff="pitch", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=False, threshold=0.01, scoff="pitch")
plt.suptitle(f"MDS_3D_Static, 8 m/s", fontsize=16, y=1.08)
...
file_names_MUS_3D_5 = ["HAR_INT_MDS_GAP_213D_02_02_000","HAR_INT_MDS_GAP_213D_02_02_004"] # 5 ms, vibrations (Finnes en fil for 6 også)
file_names_MUS_3D_8 = ["HAR_INT_MDS_GAP_213D_02_02_000","HAR_INT_MDS_GAP_213D_02_02_006"] # 8 ms, vibrations
file_names_MUS_3D_10 = ["HAR_INT_MDS_GAP_213D_02_02_000","HAR_INT_MDS_GAP_213D_02_02_005"] # 10 ms, vibrations
...
exp0_MUS_3D.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 0 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MUS_3D_5.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 5 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MUS_3D_8.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 8 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MUS_3D_10.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 10 m/s – Before filtering", fontsize=16, y=1.02)
...
exp0_MUS_3D.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 0 m/s – After filtering", fontsize=16, y=1.02)
exp1_MUS_3D_5.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 5 m/s – After filtering", fontsize=16, y=1.02)
exp1_MUS_3D_8.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 8 m/s – After filtering", fontsize=16, y=1.02)
exp1_MUS_3D_10.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 10 m/s – After filtering", fontsize=16, y=1.02)
plt.show()
...
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=True, threshold=0.05, scoff="drag")
plt.suptitle(f"MUS_3D_Static, 5 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MUS_3D_8, threshold=0.04, scoff="drag", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=True, threshold=0.04, scoff="drag")
plt.suptitle(f"MUS_3D_Static, 8 m/s", fontsize=16, y=1.08)
alpha_high, coeff_plot_up_high, coeff_plot_down_high=w3t._scoff.filter(static_coeff_MUS_3D_10, threshold=0.02, scoff="drag", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_high,coeff_plot_up_high,coeff_plot_down_high, upwind_in_rig=True, threshold=0.02, scoff="drag")
plt.suptitle(f"MUS_3D_Static, 10 m/s", fontsize=16, y=1.08)

#lift
alpha_low, coeff_plot_up_low, coeff_plot_down_low=w3t._scoff.filter(static_coeff_MUS_3D_5, threshold=0.025, scoff="lift", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=True, threshold=0.025, scoff="lift")
plt.suptitle(f"MUS_3D_Static, 5 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MUS_3D_8, threshold=0.03, scoff="lift", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med,upwind_in_rig=True, threshold=0.03, scoff="lift")
plt.suptitle(f"MUS_3D_Static, 8 m/s", fontsize=16, y=1.08)
alpha_high, coeff_plot_up_high, coeff_plot_down_high=w3t._scoff.filter(static_coeff_MUS_3D_10, threshold=0.04, scoff="lift", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_high,coeff_plot_up_high,coeff_plot_down_high, upwind_in_rig=True, threshold=0.04, scoff="lift")
plt.suptitle(f"MUS_3D_Static, 10 m/s", fontsize=16, y=1.08)
...
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=True, threshold=0.005, scoff="pitch")
plt.suptitle(f"MUS_3D_Static, 5 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MUS_3D_8, threshold=0.02, scoff="pitch", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=True, threshold=0.02, scoff="pitch")
plt.suptitle(f"MUS_3D_Static, 8 m/s", fontsize=16, y=1.08)
alpha_high, coeff_plot_up_high, coeff_plot_down_high=w3t._scoff.filter(static_coeff_MUS_3D_10, threshold=0.01, scoff="pitch", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_high,coeff_plot_up_high,coeff_plot_down_high, upwind_in_rig=True, threshold=0.01, scoff="pitch")
plt.suptitle(f"MUS_3D_Static, 10 m/s", fontsize=16, y=1.08)


#%%  Filter and plot ALT 2
static_coeff_MUS_3D_5_filtered, static_coeff_MUS_3D_8_filtered, static_coeff_MUS_3D_10_filtered = w3t._scoff.filter_by_reference(static_coeff_1=static_coeff_up_low, static_coeff_2=static_coeff_up_med, static_coeff_3=static_coeff_up_high, threshold=0.019, threshold_low=[0.05,0.025,0.005],threshold_med = [0.04,0.03,0.02],threshold_high=[0.02,0.04,0.01],single=False)
...
# Low wind speed
static_coeff_MDS_3D_6.to_excel(section_name, sheet_name="MDS - 6 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_3D_5.to_excel(section_name, sheet_name='MUS - 5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_6.to_excel(section_name, sheet_name='Single - 6 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# Medium wind speed
static_coeff_MDS_3D_8.to_excel(section_name, sheet_name="MDS - 8 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_3D_8.to_excel(section_name, sheet_name='MUS - 8 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9.to_excel(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# High wind speed
static_coeff_MDS_3D_10.to_excel(section_name, sheet_name="MDS - 10 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_3D_10.to_excel(section_name, sheet_name='MUS - 10 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9.to_excel(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

section_name = "3D_mean"

# Low wind speed
static_coeff_MDS_3D_6.to_excel_mean(section_name, sheet_name="MDS - 6 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_3D_5.to_excel_mean(section_name, sheet_name='MUS - 5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_6.to_excel_mean(section_name, sheet_name='Single - 6 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# Medium wind speed
static_coeff_MDS_3D_8.to_excel_mean(section_name, sheet_name="MDS - 8 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_3D_8.to_excel_mean(section_name, sheet_name='MUS - 8 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9.to_excel_mean(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# High wind speed
static_coeff_MDS_3D_10.to_excel_mean(section_name, sheet_name="MDS - 10 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_3D_10.to_excel_mean(section_name, sheet_name='MUS - 10 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9.to_excel_mean(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
...
# Low wind speed
static_coeff_MDS_3D_6_filtered.to_excel(section_name, sheet_name="MDS - 6 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_3D_5_filtered.to_excel(section_name, sheet_name='MUS - 5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_6_filtered.to_excel(section_name, sheet_name='Single - 6 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# Medium wind speed
static_coeff_MDS_3D_8_filtered.to_excel(section_name, sheet_name="MDS - 8 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_3D_8_filtered.to_excel(section_name, sheet_name='MUS - 8 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9_filtered.to_excel(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# High wind speed
static_coeff_MDS_3D_10_filtered.to_excel(section_name, sheet_name="MDS - 10 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_3D_10_filtered.to_excel(section_name, sheet_name='MUS - 10 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9_filtered.to_excel(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

section_name = "3D_mean_filtered"

# Low wind speed
static_coeff_MDS_3D_6_filtered.to_excel_mean(section_name, sheet_name="MDS - 6 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_3D_5_filtered.to_excel_mean(section_name, sheet_name='MUS - 5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_6_filtered.to_excel_mean(section_name, sheet_name='Single - 6 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# Medium wind speed
static_coeff_MDS_3D_8_filtered.to_excel_mean(section_name, sheet_name="MDS - 8 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_3D_8_filtered.to_excel_mean(section_name, sheet_name='MUS - 8 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9_filtered.to_excel_mean(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# High wind speed
static_coeff_MDS_3D_10_filtered.to_excel_mean(section_name, sheet_name="MDS - 10 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_3D_10_filtered.to_excel_mean(section_name, sheet_name='MUS - 10 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9_filtered.to_excel_mean(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
...
w3t._scoff.plot_compare_wind_speeds(static_coeff_single_6, static_coeff_single_9,
                             ...
                             scoff = "drag")                        
plt.gcf().suptitle(f"3D: MUS ", fontsize=16, y=1.02)
...
w3t._scoff.plot_compare_wind_speeds(static_coeff_single_6, static_coeff_single_9,
                               ...
                               static_coeff_MDS_3D_8, static_coeff_MDS_3D_10,
                                scoff = "drag")                        
plt.gcf().suptitle(f"3D: MDS ", fontsize=16, y=1.02)
...
file_names_MDS_4D_55 = ["HAR_INT_MUS_GAP_45D_02_00_000","HAR_INT_MUS_GAP_45D_02_00_002"] #5.5 ms
file_names_MDS_4D_85 = ["HAR_INT_MUS_GAP_45D_02_00_000","HAR_INT_MUS_GAP_45D_02_00_003"] # 8.5 ms, vibrations
file_names_MDS_4D_10 = ["HAR_INT_MUS_GAP_45D_02_00_000","HAR_INT_MUS_GAP_45D_02_00_004"] # 10 ms
...
exp0_MDS_4D.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 0 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MDS_4D_55.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 5 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MDS_4D_85.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 8 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MDS_4D_10.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 10 m/s – Before filtering", fontsize=16, y=1.02)
...
exp0_MDS_4D.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 0 m/s – After filtering", fontsize=16, y=1.02)
exp1_MDS_4D_55.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 5 m/s – After filtering", fontsize=16, y=1.02)
exp1_MDS_4D_85.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 8 m/s – After filtering", fontsize=16, y=1.02)
exp1_MDS_4D_10.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 10 m/s – After filtering", fontsize=16, y=1.02)
plt.show()
...
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=False, threshold=0.05, scoff="drag")
plt.suptitle(f"MDS_4D_Static, 5.5 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MDS_4D_85, threshold=0.03, scoff="drag", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=False, threshold=0.03, scoff="drag")
plt.suptitle(f"MDS_4D_Static, 8.5 m/s", fontsize=16, y=1.08)
...
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_high,coeff_plot_up_high,coeff_plot_down_high, upwind_in_rig=False, threshold=0.05, scoff="drag")
plt.suptitle(f"MDS_4D_Static, 10 m/s", fontsize=16, y=1.08)
...
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=False, threshold=0.05, scoff="lift")
plt.suptitle(f"MDS_4D_Static, 5.5 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MDS_4D_85, threshold=0.03, scoff="lift", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=False, threshold=0.03, scoff="lift")
plt.suptitle(f"MDS_4D_Static, 8.5 m/s", fontsize=16, y=1.08)
...
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=False, threshold=0.05, scoff="pitch")
plt.suptitle(f"MDS_4D_Static, 5.5 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MDS_4D_85, threshold=0.01, scoff="pitch", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=False, threshold=0.01, scoff="pitch")
plt.suptitle(f"MDS_4D_Static, 8.5 m/s", fontsize=16, y=1.08)
...
file_names_MUS_4D_5 = ["HAR_INT_MDS_GAP_45D_02_00_001","HAR_INT_MDS_GAP_45D_02_00_003"] # 5 ms, vibrations 
file_names_MUS_4D_85= ["HAR_INT_MDS_GAP_45D_02_00_001","HAR_INT_MDS_GAP_45D_02_00_004"] # 8.5 ms, vibrations
file_names_MUS_4D_10 = ["HAR_INT_MDS_GAP_45D_02_00_001","HAR_INT_MDS_GAP_45D_02_00_005"] # 10 ms, vibrations
...
exp0_MUS_4D.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 0 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MUS_4D_5.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 5 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MUS_4D_85.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 8 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MUS_4D_10.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 10 m/s – Before filtering", fontsize=16, y=1.02)
...
exp0_MUS_4D.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 0 m/s – After filtering", fontsize=16, y=1.02)
exp1_MUS_4D_5.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 5 m/s – After filtering", fontsize=16, y=1.02)
exp1_MUS_4D_85.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 8 m/s – After filtering", fontsize=16, y=1.02)
exp1_MUS_4D_10.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 10 m/s – After filtering", fontsize=16, y=1.02)
plt.show()
...
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=True, threshold=0.05, scoff="drag")
plt.suptitle(f"MUS_4D_Static, 5 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MUS_4D_85, threshold=0.04, scoff="drag", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=True, threshold=0.04, scoff="drag")
plt.suptitle(f"MUS_4D_Static, 8.5 m/s", fontsize=16, y=1.08)
alpha_high, coeff_plot_up_high, coeff_plot_down_high=w3t._scoff.filter(static_coeff_MUS_4D_10, threshold=0.02, scoff="drag", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_high,coeff_plot_up_high,coeff_plot_down_high, upwind_in_rig=True, threshold=0.02, scoff="drag")
plt.suptitle(f"MUS_4D_Static, 10 m/s", fontsize=16, y=1.08)

#lift
alpha_low, coeff_plot_up_low, coeff_plot_down_low=w3t._scoff.filter(static_coeff_MUS_4D_5, threshold=0.025, scoff="lift", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=True, threshold=0.025, scoff="lift")
plt.suptitle(f"MUS_4D_Static, 5 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MUS_4D_85, threshold=0.03, scoff="lift", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med,upwind_in_rig=True, threshold=0.03, scoff="lift")
plt.suptitle(f"MUS_4D_Static, 8.5 m/s", fontsize=16, y=1.08)
alpha_high, coeff_plot_up_high, coeff_plot_down_high=w3t._scoff.filter(static_coeff_MUS_4D_10, threshold=0.04, scoff="lift", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_high,coeff_plot_up_high,coeff_plot_down_high, upwind_in_rig=True, threshold=0.04, scoff="lift")
plt.suptitle(f"MUS_4D_Static, 10 m/s", fontsize=16, y=1.08)

#pitch
alpha_low, coeff_plot_up_low, coeff_plot_down_low=w3t._scoff.filter(static_coeff_MUS_4D_5, threshold=0.005, scoff="pitch", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=True, threshold=0.005, scoff="pitch")
plt.suptitle(f"MUS_4D_Static, 5 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MUS_4D_85, threshold=0.02, scoff="pitch", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=True, threshold=0.02, scoff="pitch")
plt.suptitle(f"MUS_4D_Static, 8.5 m/s", fontsize=16, y=1.08)
alpha_high, coeff_plot_up_high, coeff_plot_down_high=w3t._scoff.filter(static_coeff_MUS_4D_10, threshold=0.01, scoff="pitch", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_high,coeff_plot_up_high,coeff_plot_down_high, upwind_in_rig=True, threshold=0.01, scoff="pitch")
plt.suptitle(f"MUS_4D_Static, 10 m/s", fontsize=16, y=1.08)
...
# Low wind speed
static_coeff_MDS_4D_55.to_excel(section_name, sheet_name="MDS - 5.5 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_4D_5.to_excel(section_name, sheet_name='MUS - 5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_6.to_excel(section_name, sheet_name='Single - 6 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# Medium wind speed
static_coeff_MDS_4D_85.to_excel(section_name, sheet_name="MDS - 8.5 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_4D_85.to_excel(section_name, sheet_name='MUS - 8.5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9.to_excel(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# High wind speed
static_coeff_MDS_4D_10.to_excel(section_name, sheet_name="MDS - 10 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_4D_10.to_excel(section_name, sheet_name='MUS - 10 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9.to_excel(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

section_name = "4D_mean"

# Low wind speed
static_coeff_MDS_4D_55.to_excel_mean(section_name, sheet_name="MDS - 5.5 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_4D_5.to_excel_mean(section_name, sheet_name='MUS - 5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_6.to_excel_mean(section_name, sheet_name='Single - 6 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# Medium wind speed
static_coeff_MDS_4D_85.to_excel_mean(section_name, sheet_name="MDS - 8.5 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_4D_85.to_excel_mean(section_name, sheet_name='MUS - 8.5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9.to_excel_mean(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# High wind speed
static_coeff_MDS_4D_10.to_excel_mean(section_name, sheet_name="MDS - 10 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_4D_10.to_excel_mean(section_name, sheet_name='MUS - 10 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9.to_excel_mean(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
...
# Low wind speed
static_coeff_MDS_4D_55_filtered.to_excel(section_name, sheet_name="MDS - 5.5 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_4D_5_filtered.to_excel(section_name, sheet_name='MUS - 5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_6_filtered.to_excel(section_name, sheet_name='Single - 6 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# Medium wind speed
static_coeff_MDS_4D_85_filtered.to_excel(section_name, sheet_name="MDS - 8.5 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_4D_85_filtered.to_excel(section_name, sheet_name='MUS - 8.5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9_filtered.to_excel(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# High wind speed
static_coeff_MDS_4D_10_filtered.to_excel(section_name, sheet_name="MDS - 10 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_4D_10_filtered.to_excel(section_name, sheet_name='MUS - 10 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9_filtered.to_excel(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

section_name = "4D_mean_filtered"

# Low wind speed
static_coeff_MDS_4D_55_filtered.to_excel_mean(section_name, sheet_name="MDS - 5.5 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_4D_5_filtered.to_excel_mean(section_name, sheet_name='MUS - 5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_6_filtered.to_excel_mean(section_name, sheet_name='Single - 6 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# Medium wind speed
static_coeff_MDS_4D_85_filtered.to_excel_mean(section_name, sheet_name="MDS - 8.5 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_4D_85_filtered.to_excel_mean(section_name, sheet_name='MUS - 8.5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9_filtered.to_excel_mean(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# High wind speed
static_coeff_MDS_4D_10_filtered.to_excel_mean(section_name, sheet_name="MDS - 10 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_4D_10_filtered.to_excel_mean(section_name, sheet_name='MUS - 10 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9_filtered.to_excel_mean(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
...
w3t._scoff.plot_compare_wind_speeds(static_coeff_single_6, static_coeff_single_9,
                             ...
                             scoff = "drag")                        
plt.gcf().suptitle(f"4D: MUS ", fontsize=16, y=1.02)
...
w3t._scoff.plot_compare_wind_speeds(static_coeff_single_6, static_coeff_single_9,
                               ...
                               static_coeff_MDS_4D_85, static_coeff_MDS_4D_10,
                                scoff = "drag")                        
plt.gcf().suptitle(f"4D: MDS ", fontsize=16, y=1.02)
...
file_names_MDS_5D_55 = ["HAR_INT_MUS_GAP_45D_02_01_000","HAR_INT_MUS_GAP_45D_02_01_001"] # 5.5 ms
file_names_MDS_5D_85 = ["HAR_INT_MUS_GAP_45D_02_01_000","HAR_INT_MUS_GAP_45D_02_01_002"] # 8.5 ms, vibrations
file_names_MDS_5D_10 = ["HAR_INT_MUS_GAP_45D_02_01_000","HAR_INT_MUS_GAP_45D_02_01_003"] # 10 ms
...
exp0_MDS_5D.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 0 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MDS_5D_55.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 5.5 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MDS_5D_85.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 8.5 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MDS_5D_10.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 10 m/s – Before filtering", fontsize=16, y=1.02)
...
exp0_MDS_5D.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 0 m/s – After filtering", fontsize=16, y=1.02)
exp1_MDS_5D_55.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 5.5 m/s – After filtering", fontsize=16, y=1.02)
exp1_MDS_5D_85.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 8.5 m/s – After filtering", fontsize=16, y=1.02)
exp1_MDS_5D_10.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 10 m/s – After filtering", fontsize=16, y=1.02)
plt.show()
...
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=False, threshold=0.05, scoff="drag")
plt.suptitle(f"MDS_5D_Static, 5.5 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MDS_5D_85, threshold=0.03, scoff="drag", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=False, threshold=0.03, scoff="drag")
plt.suptitle(f"MDS_5D_Static, 8.5 m/s", fontsize=16, y=1.08)
...
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_high,coeff_plot_up_high,coeff_plot_down_high, upwind_in_rig=False, threshold=0.05, scoff="drag")
plt.suptitle(f"MDS_5D_Static, 10 m/s", fontsize=16, y=1.08)
...
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=False, threshold=0.05, scoff="lift")
plt.suptitle(f"MDS_5D_Static, 5.5 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MDS_5D_85, threshold=0.03, scoff="lift", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=False, threshold=0.03, scoff="lift")
plt.suptitle(f"MDS_5D_Static, 8.5 m/s", fontsize=16, y=1.08)
...
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=False, threshold=0.05, scoff="pitch")
plt.suptitle(f"MDS_5D_Static, 5.5 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MDS_5D_85, threshold=0.01, scoff="pitch", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=False, threshold=0.01, scoff="pitch")
plt.suptitle(f"MDS_5D_Static, 8.5 m/s", fontsize=16, y=1.08)
...
file_names_MUS_5D_45 = ["HAR_INT_MDS_GAP_45D_02_01_000","HAR_INT_MDS_GAP_45D_02_01_002"] # 4.5 ms, vibrations 
file_names_MUS_5D_85 = ["HAR_INT_MDS_GAP_45D_02_01_000","HAR_INT_MDS_GAP_45D_02_01_003"] # 8.5 ms, vibrations
file_names_MUS_5D_10 = ["HAR_INT_MDS_GAP_45D_02_01_000","HAR_INT_MDS_GAP_45D_02_01_004"] # 10 ms, vibrations
...
exp0_MUS_5D.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 0 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MUS_5D_45.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 4.5 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MUS_5D_85.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 8.5 m/s – Before filtering", fontsize=16, y=1.02)
exp1_MUS_5D_10.plot_experiment() #Before filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 10 m/s – Before filtering", fontsize=16, y=1.02)
...
exp0_MUS_5D.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 0 m/s – After filtering", fontsize=16, y=1.02)
exp1_MUS_5D_45.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 4.5 m/s – After filtering", fontsize=16, y=1.02)
exp1_MUS_5D_85.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 8.5 m/s – After filtering", fontsize=16, y=1.02)
exp1_MUS_5D_10.plot_experiment() #After filtering
plt.gcf().suptitle(f"{section_name} (ref excel) 10 m/s – After filtering", fontsize=16, y=1.02)
plt.show()
...
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=True, threshold=0.05, scoff="drag")
plt.suptitle(f"MUS_5D_Static, 4.5 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MUS_5D_85, threshold=0.04, scoff="drag", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=True, threshold=0.04, scoff="drag")
plt.suptitle(f"MUS_5D_Static, 8.5 m/s", fontsize=16, y=1.08)
alpha_high, coeff_plot_up_high, coeff_plot_down_high=w3t._scoff.filter(static_coeff_MUS_5D_10, threshold=0.02, scoff="drag", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_high,coeff_plot_up_high,coeff_plot_down_high, upwind_in_rig=True, threshold=0.02, scoff="drag")
plt.suptitle(f"MUS_5D_Static, 10 m/s", fontsize=16, y=1.08)

#lift
alpha_low, coeff_plot_up_low, coeff_plot_down_low=w3t._scoff.filter(static_coeff_MUS_5D_45, threshold=0.025, scoff="lift", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=True, threshold=0.025, scoff="lift")
plt.suptitle(f"MUS_5D_Static, 4.5 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MUS_5D_85, threshold=0.03, scoff="lift", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med,upwind_in_rig=True, threshold=0.03, scoff="lift")
plt.suptitle(f"MUS_5D_Static, 8.5 m/s", fontsize=16, y=1.08)
alpha_high, coeff_plot_up_high, coeff_plot_down_high=w3t._scoff.filter(static_coeff_MUS_5D_10, threshold=0.04, scoff="lift", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_high,coeff_plot_up_high,coeff_plot_down_high, upwind_in_rig=True, threshold=0.04, scoff="lift")
plt.suptitle(f"MUS_5D_Static, 10 m/s", fontsize=16, y=1.08)

#pitch
alpha_low, coeff_plot_up_low, coeff_plot_down_low=w3t._scoff.filter(static_coeff_MUS_5D_45, threshold=0.005, scoff="pitch", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_low,coeff_plot_up_low,coeff_plot_down_low, upwind_in_rig=True, threshold=0.005, scoff="pitch")
plt.suptitle(f"MUS_5D_Static, 4.5 m/s", fontsize=16, y=1.08)
alpha_med, coeff_plot_up_med, coeff_plot_down_med=w3t._scoff.filter(static_coeff_MUS_5D_85, threshold=0.02, scoff="pitch", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_med,coeff_plot_up_med,coeff_plot_down_med, upwind_in_rig=True, threshold=0.02, scoff="pitch")
plt.suptitle(f"MUS_5D_Static, 8.5 m/s", fontsize=16, y=1.08)
alpha_high, coeff_plot_up_high, coeff_plot_down_high=w3t._scoff.filter(static_coeff_MUS_5D_10, threshold=0.01, scoff="pitch", single = False)
w3t._scoff.plot_static_coeff_filtered_out_above_threshold(alpha_high,coeff_plot_up_high,coeff_plot_down_high, upwind_in_rig=True, threshold=0.01, scoff="pitch")
plt.suptitle(f"MUS_5D_Static, 10 m/s", fontsize=16, y=1.08)
...
# Low wind speed
static_coeff_MDS_5D_55.to_excel(section_name, sheet_name="MDS - 5.5 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_5D_45.to_excel(section_name, sheet_name='MUS - 4.5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_6.to_excel(section_name, sheet_name='Single - 6 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# Medium wind speed
static_coeff_MDS_5D_85.to_excel(section_name, sheet_name="MDS - 8.5 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_5D_85.to_excel(section_name, sheet_name='MUS - 8.5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9.to_excel(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# High wind speed
static_coeff_MDS_5D_10.to_excel(section_name, sheet_name="MDS - 10 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_5D_10.to_excel(section_name, sheet_name='MUS - 10 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9.to_excel(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

section_name = "5D_mean"

# Low wind speed
static_coeff_MDS_5D_55.to_excel_mean(section_name, sheet_name="MDS - 5.5 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_5D_45.to_excel_mean(section_name, sheet_name='MUS - 4.5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_6.to_excel_mean(section_name, sheet_name='Single - 6 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# Medium wind speed
static_coeff_MDS_5D_85.to_excel_mean(section_name, sheet_name="MDS - 8.5 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_5D_85.to_excel_mean(section_name, sheet_name='MUS - 8.5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9.to_excel_mean(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# High wind speed
static_coeff_MDS_5D_10.to_excel_mean(section_name, sheet_name="MDS - 10 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_5D_10.to_excel_mean(section_name, sheet_name='MUS - 10 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9.to_excel_mean(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
...
# Low wind speed
static_coeff_MDS_5D_55_filtered.to_excel(section_name, sheet_name="MDS - 5.5 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_5D_45_filtered.to_excel(section_name, sheet_name='MUS - 4.5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_6_filtered.to_excel(section_name, sheet_name='Single - 6 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# Medium wind speed
static_coeff_MDS_5D_85_filtered.to_excel(section_name, sheet_name="MDS - 8.5 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_5D_85_filtered.to_excel(section_name, sheet_name='MUS - 8.5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9_filtered.to_excel(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# High wind speed
static_coeff_MDS_5D_10_filtered.to_excel(section_name, sheet_name="MDS - 10 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_5D_10_filtered.to_excel(section_name, sheet_name='MUS - 10 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9_filtered.to_excel(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

section_name = "5D_mean_filtered"

# Low wind speed
static_coeff_MDS_5D_55_filtered.to_excel_mean(section_name, sheet_name="MDS - 5.5 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_5D_45_filtered.to_excel_mean(section_name, sheet_name='MUS - 4.5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_6_filtered.to_excel_mean(section_name, sheet_name='Single - 6 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# Medium wind speed
static_coeff_MDS_5D_85_filtered.to_excel_mean(section_name, sheet_name="MDS - 8.5 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_5D_85_filtered.to_excel_mean(section_name, sheet_name='MUS - 8.5 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9_filtered.to_excel_mean(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)

# High wind speed
static_coeff_MDS_5D_10_filtered.to_excel_mean(section_name, sheet_name="MDS - 10 ms" ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=False)
static_coeff_MUS_5D_10_filtered.to_excel_mean(section_name, sheet_name='MUS - 10 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
static_coeff_single_9_filtered.to_excel_mean(section_name, sheet_name='Single - 9 ms' ,section_width=18.3/100,section_height=3.33/100,section_length_in_rig=2.68, section_length_on_wall=2.66, upwind_in_rig=True)
...
w3t._scoff.plot_compare_wind_speeds(static_coeff_single_6, static_coeff_single_9,
                             ...
                             scoff = "drag")                        
plt.gcf().suptitle(f"5D: MUS ", fontsize=16, y=1.02)
