...
damping_ratios_single, omega_all_single, eigvals_all_single, eigvecs_all_single= _eigVal.solve_omega(poly_coeff_single, ms1, ms2, fs1, fs2, B, rho, zeta,  eps, N = 100, single = True)
...
damping_ratios_1D, omega_all_1D, eigvals_all_1D, eigvecs_all_1D= _eigVal.solve_omega(poly_coeff_1D, ms1, ms2, fs1, fs2, B, rho, zeta,  eps, N = 100, single = False)
...
damping_ratios_2D, omega_all_2D, eigvals_all_2D, eigvecs_all_2D= _eigVal.solve_omega(poly_coeff_2D, ms1, ms2, fs1, fs2, B, rho, zeta,  eps, N = 100, single = False)
...
damping_ratios_3D, omega_all_3D, eigvals_all_3D, eigvecs_all_3D= _eigVal.solve_omega(poly_coeff_3D, ms1, ms2, fs1, fs2, B, rho, zeta,  eps, N = 100, single = False)
...
damping_ratios_4D, omega_all_4D, eigvals_all_4D, eigvecs_all_4D= _eigVal.solve_omega(poly_coeff_4D, ms1, ms2, fs1, fs2, B, rho, zeta,  eps, N = 100, single = False)
...
damping_ratios_5D, omega_all_5D, eigvals_all_5D, eigvecs_all_5D= _eigVal.solve_omega(poly_coeff_5D, ms1, ms2, fs1, fs2, B, rho, zeta,  eps, N = 100, single = False)
