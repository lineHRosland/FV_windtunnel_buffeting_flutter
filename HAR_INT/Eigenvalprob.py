...
#%%
#Structural matrices for single deck
Ms, Cs, Ks = _eigVal.structural_matrices(m1V, m1T, f1V, f1T, zeta, single = True)

#%%
#Solve for eigenvalues and eigenvectors
damping_ratios_single, omega_all_single, eigvals_all_single, eigvecs_all_single = _eigVal.solve_omega(poly_coeff_single, Ms, Cs, Ks, f1V, f1T, B, rho, zeta,  eps, N=200, single = True)
...
#%%
#Plotting
_eigVal.plot_damping_vs_wind_speed_single(damping_ratios_single, dist="Single deck", N=200, single = True)

_eigVal.plot_frequency_vs_wind_speed(B,  v_range_single, omega_all_single, dist="Single deck", N=200, single = True)
...
Ms, Cs, Ks = _eigVal.structural_matrices(m1V, m1T, f1V, f1T, zeta, single = False)

damping_ratios_1D, omega_all_1D, eigvals_all_1D, eigvecs_all_1D = _eigVal.solve_omega(poly_coeff_1D, Ms, Cs, Ks, f1V, f1T, B, rho, zeta,  eps, N=200, single = False)


flutter_speed_modes_1D, flutter_idx_modes_1D=_eigVal.solve_flutter_speed( damping_ratios_1D, N=200, single = False)
...
_eigVal.plot_damping_vs_wind_speed_single(damping_ratios_1D, dist="1D", N=200, single = False)

_eigVal.plot_frequency_vs_wind_speed(B, v_range_1D, omega_all=omega_all_1D, dist="1D",N=200, single = False)
...
damping_ratios_2D, omega_all_2D, eigvals_all_2D, eigvecs_all_2D = _eigVal.solve_omega(poly_coeff_2D, Ms, Cs, Ks,  f1V, f1T, B, rho, zeta,  eps, N=200, single = False)


flutter_speed_modes_2D, flutter_idx_modes_2D=_eigVal.solve_flutter_speed( damping_ratios_2D, N=200, single = False)
...
_eigVal.plot_damping_vs_wind_speed_single(damping_ratios_2D,   dist="2D",N=200, single = False)

_eigVal.plot_frequency_vs_wind_speed(B, v_range_2D, omega_all=omega_all_2D, dist="2D",N=200, single = False)
...
damping_ratios_3D, omega_all_3D, eigvals_all_3D, eigvecs_all_3D = _eigVal.solve_omega(poly_coeff_3D, Ms, Cs, Ks, f1V, f1T, B, rho, zeta,  eps, N=200, single = False)


flutter_speed_modes_3D, flutter_idx_modes_3D=_eigVal.solve_flutter_speed( damping_ratios_3D, N=200, single = False)
...
_eigVal.plot_damping_vs_wind_speed_single(damping_ratios_3D, dist="3D",N=200, single = False)
_eigVal.plot_frequency_vs_wind_speed(B, v_range_3D, omega_all=omega_all_3D,dist="3D",N=200, single = False)
...
damping_ratios_4D, omega_all_4D, eigvals_all_4D, eigvecs_all_4D = _eigVal.solve_omega(poly_coeff_4D, Ms, Cs, Ks,  f1V, f1T, B, rho, zeta,  eps, N=200, single = False)

flutter_speed_modes_4D, flutter_idx_modes_4D=_eigVal.solve_flutter_speed( damping_ratios_4D, N=200, single = False)
...
_eigVal.plot_damping_vs_wind_speed_single(damping_ratios_4D,dist="4D",N=200, single = False)
_eigVal.plot_frequency_vs_wind_speed(B, v_range_4D, omega_all=omega_all_4D,   dist="4D",N=200, single = False)
...
damping_ratios_5D, omega_all_5D, eigvals_all_5D, eigvecs_all_5D = _eigVal.solve_omega(poly_coeff_5D, Ms, Cs, Ks, f1V, f1T, B, rho, zeta,  eps, N=200, single = False)


flutter_speed_modes_5D, flutter_idx_modes_5D=_eigVal.solve_flutter_speed( damping_ratios_5D, N=200, single = False)
...
_eigVal.plot_damping_vs_wind_speed_single(damping_ratios_5D, dist="5D",N=200, single = False)
_eigVal.plot_frequency_vs_wind_speed(B, v_range_5D, omega_all=omega_all_5D, dist="5D", N=200, single = False)
